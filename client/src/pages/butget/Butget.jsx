// import StyleButget from './Butget.module.css'
import React, { useState, useEffect } from "react";
import Swal from "sweetalert2";
import x from "../home/Home.module.css";
...
const Butget = () => {
    ...
    const [cart, setCart] = useState(() => {
        const savedProducts = localStorage.getItem("products-butget");
        return {
            discount: 0,
    ...
    useEffect(() => {
        localStorage.setItem("products-butget", JSON.stringify(cart.products));
    }, [cart.products]);
    ...
    const addToCart = (id) => {
        ...
        if (product.isActive === false) return alert(`El producto "${product.name}" pausado por el admin.`)
